                ...
                <div className="space-y-3">
                    ...
                    >
                        ...
                        <div className="text-xs leading-5" style={{ color: colors.text2 }}>
                            1. 输入你的需求  2. 点击「查找可用 Agent」  3. 点击「执行推荐」或「执行已选」
                        </div>
                    ...
                    <div
                        ...
                        style={{ backgroundColor: colors.bg1, border: `1px solid ${mktColors.primaryMuted}` }}
                    >
                        <div className="text-xs" style={{ color: colors.text2 }}>
                            <span style={{ color: colors.text1, fontWeight: 600 }}>数字分身已参与决策</span>
                            <span style={{ marginLeft: 8 }}>{twinSummary}</span>
                        </div>
                        <span
                            className="text-[10px] px-1.5 py-0.5 rounded"
                            style={{ backgroundColor: mktColors.primaryMuted, color: mktColors.primary }}
                        >
                    ...
                    {leaderboardRows.length > 0 && (
                        <div
                            ...
                            style={{ backgroundColor: colors.bg1, border: `1px solid ${colors.border}` }}
                        >
                            <div className="text-xs font-medium mb-2" style={{ color: colors.text1 }}>
                                市场热度榜（7天）
                            </div>
                    ...
                    <div>
                        ...
                        >
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                <div>
                                    <label className="text-[11px]" style={{ color: colors.text3 }}>业务目标</label>
                                    <input
                                        value={businessGoal}
                                        onChange={(e) => setBusinessGoal(e.target.value)}
                                        className="w-full mt-1 px-2.5 py-2 rounded-lg text-xs focus:outline-none focus:ring-2 focus:ring-sky-500/50"
                                        style={{ backgroundColor: colors.bg3, color: colors.text1, border: `1px solid ${colors.border}` }}
                                        placeholder="例如：提升门店转化率"
                                    />
                                </div>
                                <div>
                                    <label className="text-[11px]" style={{ color: colors.text3 }}>预算范围</label>
                                    <input
                                ...
                                <div>
                                    <label className="text-[11px]" style={{ color: colors.text3 }}>完成时限</label>
                                    <input
                                ...
                                <div>
                                    <label className="text-[11px]" style={{ color: colors.text3 }}>行业场景</label>
                                    <select
                                ...
                                <div className="col-span-2">
                                    <label className="text-[11px]" style={{ color: colors.text3 }}>LIX 交付偏好</label>
                                    <select
                        ...
                        <label className="text-xs font-medium" style={{ color: colors.text3 }}>用户需求</label>
                        <textarea
                            value={query}
                        ...
                        />
                        <p className="text-[11px] mt-1.5" style={{ color: colors.text3 }}>
                    ...
                    <div className="flex gap-2">
                        ...
                        <button
                            ...
                            className="px-4 py-2.5 rounded-lg text-sm font-medium flex items-center gap-2 disabled:opacity-60"
                            style={{ backgroundColor: colors.positive, color: '#fff' }}
                        >
            ...
            {data && (
                <>
                                ...
                                return (
                                    <div
                                        ...
                                        style={{
                                            ...
                                            boxShadow: isSelected ? `0 0 8px ${colors.primary}15` : 'none',
                                            cursor: 'pointer',
                                    ...
                                    >
                                        <div className="flex items-center justify-between mb-1 gap-3">
                                            <div className="flex items-center gap-2 flex-1">
                                                ...
                                                <div className="text-sm font-medium" style={{ color: colors.text1 }}>{c.name}</div>
                                                <span className="text-[10px] px-1.5 py-0.5 rounded" style={{ backgroundColor: mktColors.primaryMuted, color: mktColors.primary }}>
                                                    已交付
                                                </span>
                                            </div>
                                            <div className="text-xs font-mono" style={{ color: colors.positive }}>
                                                {c.total.toFixed(2)}
                                            </div>
                                        </div>
                                        <div style={{ display: 'flex', gap: 12, fontSize: 11, color: colors.text3, marginTop: 6 }}>
                                            <span>fit <span style={{ color: colors.text2 }}>{c.fit.toFixed(2)}</span></span>
                                            <span>rel <span style={{ color: colors.text2 }}>{c.reliabilityKnown ? c.reliability.toFixed(2) : '—'}</span></span>
                                            <span>fresh <span style={{ color: colors.text2 }}>{c.freshness.toFixed(2)}</span></span>
                                            <span>lat <span style={{ color: colors.text2 }}>{c.latencyKnown ? c.latency.toFixed(2) : '—'}</span></span>
                                            <span>twin <span style={{ color: colors.text2 }}>{Number.isFinite(c.twinBoost) ? c.twinBoost!.toFixed(2) : '0.00'}</span></span>
                                        </div>
                                        {(typeof monetization.pricePerUseCny === 'number' || typeof monetization.revenueTotalCny === 'number') && (
                                            <div style={{ display: 'flex', gap: 10, fontSize: 11, color: colors.text3, marginTop: 6 }}>
                                                ...
                                                {typeof monetization.revenueTotalCny === 'number' && (
                                                    <span style={{ color: colors.warning }}>累计收益 ¥{monetization.revenueTotalCny.toFixed(0)}</span>
                                                )}
                                        ...
                                        <div className="flex items-center justify-between mb-1 gap-3">
                                            <div className="flex items-center gap-2 flex-1">
                                                ...
                                                <span
                                                    className="text-[10px] px-1.5 py-0.5 rounded"
                                                    style={{
                                                        backgroundColor: isSelected ? mktColors.primaryMuted : colors.bg3,
                                                        color: isSelected ? mktColors.primary : colors.text3,
                                                    }}
                                                >
                    ...
                    {data.rejected.length > 0 && showCandidates && (
                        <div className="space-y-2">
                            <h4 className="text-xs font-medium uppercase tracking-wider px-1" style={{ color: colors.text3 }}>
                            ...
                            {data.rejected.slice(0, 5).map((r) => (
                                <div
                                    ...
                                    style={{ backgroundColor: colors.bg2, border: `1px solid ${colors.border}` }}
                                >
                                    <div className="flex items-center gap-2 text-xs" style={{ color: colors.text1 }}>
                                        <ShieldAlert size={12} style={{ color: colors.warning }} />
                                        {r.name}
                                        <span style={{ color: colors.danger, marginLeft: 'auto', fontSize: 11 }}>
